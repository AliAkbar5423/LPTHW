...
def main():
	...
	if len(sys.argv[1:]) != 5:
		print "Cara penggunaan: ./proxy.py [localhost], [localport], [remotehost], [remoteport], [receive_first]"
...
# rinse, wash, repeat
	...
	while True:
		...
		if len(local_buffer):
			...
			#send to response to the local socket
			client_socket.send(remote_buffer)
...
#this is pretty hex dumping function direcly taken from
# the comments here:
# http://code.activstate.com/recipes/142812-hex-dumper/
