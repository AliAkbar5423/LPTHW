...
def usage():
	print "BHP Net Tool"
	print
	print "Cara Penggunaan: bhpnet.py -t target_host -p port"
...
def main():
	...
	#upload things, execute command, and drop shell back
...
def server_loop():
	...
	while True:
		client_socket, addr = server_accept()
...
def client_handler(client_socket):
	...
	if len(upload_destination):
		...
		try:
			...
			client_socket.send("Successfuly saved file to %s\r\n" % upload_destination)
